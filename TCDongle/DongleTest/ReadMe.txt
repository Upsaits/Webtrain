========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : DongleTest
========================================================================


Diese DongleTest-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre DongleTest-Anwendung bilden.
...
DongleTest.h
	...
	Anwendungsklasse CDongleTestApp.
...
res\DongleTest.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei DongleTest.rc eingebunden.
...
DongleTestDlg.h, DongleTestDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CDongleTestDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in DongleTest.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	DongleTest.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
