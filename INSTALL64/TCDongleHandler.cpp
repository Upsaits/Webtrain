...
void CTCDongleHandler::Init()
{
}

void CTCDongleHandler::Exit()
{
}


// Dongle-ID auslesen
long CTCDongleHandler::GetDongleID() 
{
	return 0;
}


BOOL CTCDongleHandler::ReadDongle() 
{
	return FALSE;
}

BOOL CTCDongleHandler::WriteDongle() 
{
	return FALSE;
}
