...
// 
// Rev 002 : Patrick Vanden Driessche <pvdd@devbrains.be> added a few enhancements
//           Small Enhancements/Bugfix - 11 january 2003
...
namespace SoftObject.SOComponents.Forms
{
	...
	/// </summary>
	public class SOTaskbarNotifier : XtraForm
	{
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SOTaskbarNotifier));
            this.SuspendLayout();
            // 
            // SOTaskbarNotifier
            // 
